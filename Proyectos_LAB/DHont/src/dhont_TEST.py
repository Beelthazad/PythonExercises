...
def test_calcula_diccionario_2d(votos):
    tabla_votos = calcula_diccionario_2d(votos)
...
def test_calcula_escaños_provincia(votos, escaños):
    ...
    votos_provincias = calcula_diccionario_2d(votos)
...
print(votos[:10], '\n')
print('ESCAÑOS POR PROVINCIA: ', escaños, '\n')
    
#test_calcula_provincias(votos, escaños)
#test_calcula_partidos(votos)
#test_calcula_diccionario_2d(votos)
